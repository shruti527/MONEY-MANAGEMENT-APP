...
my_img=PhotoImage(file="C:\\Users\\ADITYA\\Desktop\\getty_505872010_130300.png")
...
def mainscreen(*arug):
  ...
  #-profile menu
  m1=Menu(my_menu)
  m1.add_command(label='Edit',command=exec(open('C:\\MONEY MANGEMENT APP\\for_personal_details.py'))
  m1.add_command(label='log out',command=exec(open(file='C:\\MONEY MANGEMENT APP\\login.py'))
  #-file menu
  m2=Menu(my_menu)
  ...
  e2.grid(row=5,column=3 e3.grid(row=6,column=3)
